...
--
-- 1) select절, insert절의 values(...)의 서브쿼리
--
...
-- 3-1) 단일 행 연산자: =, >, <, >=, <=, <>, !=
-- 실습문제 1: 현재, 전체 사원의 평균 연봉보다 적은 연봉을 받는 사원의 이름과 급여를 출력하세요
...
-- 실습문제2: 현재, 가장 적은 평균 급여의 직책과 그 평균 급여를 출력하세요
...
-- 실습문제 4: 현재, 각 부서별로 최고 연봉을 받고 있는 부서 이름, 직원 이름, 최고 연봉을 출력하세요
